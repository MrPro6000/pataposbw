...
// Edge functions handle all Supabase access for public payment pages
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {["orange", "smega", "myzaka", "poso", "wallet"].map((p) => (
                    <button key={p} onClick={() => setMobileProvider(p)}
                      ...
                      {p === "myzaka" ? "MyZaka" : p === "poso" ? "POSO Money" : p === "wallet" ? "Pata Wallet" : p.charAt(0).toUpperCase() + p.slice(1)}
                    </button>
                  ))}
                </div>
              </div>
              ...
              <p className="text-xs text-muted-foreground bg-muted rounded-xl p-3">
                You will receive a prompt on your {mobileProvider === "myzaka" ? "MyZaka" : mobileProvider === "poso" ? "POSO Money" : mobileProvider === "wallet" ? "Pata Wallet" : mobileProvider.charAt(0).toUpperCase() + mobileProvider.slice(1)} app to confirm payment of P{link.amount.toFixed(2)}.
              </p>
              <Button
