          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-muted-foreground">Payments made easier, no hassle, no contract.</span>
              </div>
              ...
              >
                ...
                {"showDownload" in feature && feature.showDownload && (
                  <div className="flex gap-2 mb-4">
                    <a href="#" className="text-xs bg-muted px-3 py-1.5 rounded-full text-muted-foreground hover:text-foreground transition-colors">
                      Android App
                    </a>
                    <a href="#" className="text-xs bg-muted px-3 py-1.5 rounded-full text-muted-foreground hover:text-foreground transition-colors">
                      iOS App
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Link to="/products" className="bg-gradient-to-br from-info/10 to-info/5 dark:from-info/20 dark:to-info/10 rounded-2xl p-8 hover:from-info/20 transition-colors group border border-info/20">
              ...
              <p className="text-muted-foreground mb-4">Fast, secure international money transfers via Mukuru. Send and receive across borders at competitive rates.</p>
