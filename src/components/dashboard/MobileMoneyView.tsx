...
const MobileMoneyView = ({ profile, userEmail }: MobileMoneyViewProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-muted to-pata-cream dark:from-background dark:to-background pb-24">
      ...
      {/* Mobile Money Loans — single full-width card */}
      <div className="px-5 pb-3">
        <button
          onClick={() => setLoanApplicationOpen(true)}
          className="w-full bg-gradient-to-br from-amber-50 to-amber-100/50 dark:from-amber-900/20 dark:to-amber-800/10 rounded-2xl p-5 active:scale-98 transition-transform text-left border border-amber-200/50 dark:border-amber-700/30 shadow-sm"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl flex items-center justify-center shadow-lg shadow-amber-500/20 flex-shrink-0">
              <Smartphone className="w-6 h-6 text-amber-100" />
            </div>
            <div className="flex-1">
              <p className="font-semibold text-foreground">Mobile Money Loans</p>
              <p className="text-sm text-muted-foreground">Apply & set your own repayment plan</p>
            </div>
      ...
      <div className="px-5 pb-3">
        <button
          ...
          className="w-full bg-gradient-to-br from-cyan-50 to-cyan-100/50 dark:from-cyan-900/20 dark:to-cyan-800/10 rounded-2xl p-5 active:scale-98 transition-transform text-left border border-cyan-200/50 dark:border-cyan-700/30 shadow-sm"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-xl flex items-center justify-center shadow-lg shadow-cyan-500/20 flex-shrink-0">
              <span className="text-xl">💰</span>
            </div>
            <div className="flex-1">
              <p className="font-semibold text-foreground">Pata Capital</p>
              <p className="text-sm text-muted-foreground">Business funding — find out more</p>
            </div>
            <ChevronRight className="w-5 h-5 text-muted-foreground flex-shrink-0" />
          </div>
        </button>
      ...
      <div className="px-5 pb-3">
        <button
          ...
          className="w-full bg-gradient-to-br from-orange-50 to-orange-100/50 dark:from-orange-900/20 dark:to-orange-800/10 rounded-2xl p-5 active:scale-98 transition-transform text-left border border-orange-200/50 dark:border-orange-700/30 shadow-sm"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center shadow-lg shadow-orange-500/20 flex-shrink-0">
      ...
      <div className="px-5 pb-3">
        ...
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-800 rounded-xl flex items-center justify-center flex-shrink-0">
              <Percent className="w-6 h-6 text-slate-600 dark:text-slate-300" />
            </div>
            <div className="flex-1">
              <p className="font-semibold text-foreground">Fees</p>
              <p className="text-sm text-muted-foreground">All fees related to your business</p>
            </div>
            <ChevronRight className="w-5 h-5 text-muted-foreground flex-shrink-0" />
          </div>
        </button>
