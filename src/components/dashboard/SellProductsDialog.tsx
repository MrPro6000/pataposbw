...
const allProducts: Product[] = [
  ...
  // Transport
  { id: "transport-gaborone-tlokweng", name: "Gaborone → Tlokweng", price: 10, category: "Transport" },
  { id: "transport-gaborone-mogoditshane", name: "Gaborone → Mogoditshane", price: 8, category: "Transport" },
  { id: "transport-gaborone-molepolole", name: "Gaborone → Molepolole", price: 30, category: "Transport" },
  { id: "transport-gaborone-francistown", name: "Gaborone → Francistown", price: 150, category: "Transport" },
  ...
  // Government / Services
  { id: "licence-fee", name: "Licence Fee", price: 250, category: "Services" },
  { id: "levy-payment", name: "Levy Payment", price: 500, category: "Services" },
];
          ...
          {step === "products" && (
            <div className="space-y-4">
              <div className="relative">
                ...
                <Input placeholder="Search products, transport, devices..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-10" />
              </div>
